...
export default function EditPromotionPage() {
  ...
  const isSpecialAudiencePromotion = Boolean(audienceType);
          ...
          <Card variant="outlined" className="p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <p className="text-gray-700">
                Audience type:{" "}
                <span className="font-semibold">
                  {(promotion as { audienceType?: string | null })
                    .audienceType || "-"}
                </span>
              </p>
              <p className="text-gray-700">
        ...
        {isViewMode && isMyPartnerSpecialPromotion && (
          <Card variant="outlined" className="p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <p className="text-gray-700">
                Audience type:{" "}
                <span className="font-semibold">{audienceType}</span>
              </p>
              <p className="text-gray-700">
                Apply channel:{" "}
                <span className="font-semibold">{formData.applyChannel}</span>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={() =>
                    handleInputChange("applicableDateType", "STAY")
                  }
                  className={`flex-1 px-6 py-4 rounded-xl font-semibold transition-all duration-200 ${
                    formData.applicableDateType === "STAY"
                      ...
                      <div className="flex gap-4">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            onChange={() =>
                              handleInputChange("payAtHotel", true)
                            }
                            className="w-4 h-4 text-blue-600"
                          />
                          <span className="text-sm text-gray-700">Yes</span>
