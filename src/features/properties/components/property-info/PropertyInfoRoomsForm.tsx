...
import { submitPropertyInfoRoomAmenitiesStep } from "@/features/properties/submitter/propertyInfoRoomSubmitters";
import {
  adminService,
  type HotelRoomDetailsResponse,
} from "@/features/admin/services/adminService";
import { RoomDetailsReducer } from "@/features/properties/state/reducer";
import {
  initialRoomState,
  initialState,
} from "@/features/properties/state/initialState";
import {
  setRoomDetails,
...
export function PropertyInfoRoomsForm({
  ...
  useEffect(() => {
    async function fetchRoomDetails() {
      ...
      try {
        setIsLoading(true);
        const response = await adminService.getRoomDetails(
          hotelId,
          editingRoomId,
        );
  ...
  useEffect(() => {
    // Keep user at the top whenever step changes inside room create/edit form.
