...
export function HelpdeskInfoRow({
  ...
  return (
    <div className="flex items-start gap-3 rounded-lg py-2">
      <div className="mt-0.5 flex h-7.5 w-7.5 shrink-0 items-center justify-center rounded-md bg-slate-100 text-slate-500">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p
          className={cn(
            "mt-0.5 break-all text-[15px] font-medium text-slate-900",
